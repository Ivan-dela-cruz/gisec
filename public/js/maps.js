    ...
    function mainMap() {
        ...
        function setData(data) {
            ...
            for(var i=0; i<lista.length; i++) {
                locations.push([locationData(lista[i].url,lista[i].title,lista[i].image,lista[i].description,lista[i].location,lista[i].ip, lista[i].rating,lista[i].views),lista[i].latitude,lista[i].longitude,i,markerIcon])
